        ...
        <form action="ManterPais.do" method="post">
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="populacao" id="populacao" required maxlength="100" placeholder="populacao">
                </div>

                <div class="form-group col-md-6">
                    <label for="area">Area</label>
                    <input type="text" class="form-control" name="area" id="area" required maxlength="100" placeholder="area">
                </div>
            </div>
            <hr />
